...
$scope.hoyLetras = $scope.hoy.toDateString()
...
$http.get("http://feed.evangelizo.org/v2/reader.php?date="+$scope.hoy+"&type=reading&lang=SP&content=GSP").then(function(result){	
